...
Source: https://github.com/tensorflow/tensor2tensor/blob/e1f0e3a746bb322f4bf3975fad2c8105b3a43a49/tensor2tensor/utils/multistep_optimizer_test.py
"""
import numpy as np
import tensorflow.compat.v1 as tf

from meta_blocks.optimizers import multistep_optimizer
...
class MultistepAdamOptimizerTest(tf.test.TestCase):
    ...
    def testResourceVariables(self):
        v1 = tf.Variable([1.0, 2.0], use_resource=True)
        v2 = tf.Variable([3.0, 4.0], use_resource=True)
